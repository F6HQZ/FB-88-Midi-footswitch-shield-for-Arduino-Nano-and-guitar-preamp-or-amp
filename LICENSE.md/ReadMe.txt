FB-88 Midi footswitch interface for guitar preamp/amp/combo, ot to upgrade to Midi one which has no Midi capability.

Writed in C language.

Build for an Arduino/Nano.
